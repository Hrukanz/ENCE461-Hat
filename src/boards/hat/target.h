...
#define CHANNEL_SEL_0 PA8_PIO
#define CHANNEL_SEL_1 PA9_PIO

/* LED tape  */
#define LEDTAPE_PIO PA30_PIO

/* ACCEL */
#define ADXL345_ADDRESS 0x1D

/* BUZZER*/
#define BUZZ_PIN PB5_PIO
